...
<head>
    ...
    <script type="text/javascript">
        window._wpemojiSettings = {"baseUrl":"http:\/\/s.w.org\/images\/core\/emoji\/72x72\/","ext":".png","source":{"concatemoji":"http:\/\/127.0.0.1\/wp_eslite\/wp-includes\/js\/wp-emoji-release.min.js?ver=4.2.3"}};
...
<div id="page" class="hfeed site">
    ...
    <section id="mastwrap" class="sliding nav-opened ">
                ...
                <div class="row">
                    ...
                    <article class="col-md-6 text-right">
                        <ul class="footer-social">
                            ...
                            <li><a href="designova" target="_blank"><img alt="誠品行旅" src="http://new.eslitehotel.com/skin/images/social_icons/google.png"></a></li>
